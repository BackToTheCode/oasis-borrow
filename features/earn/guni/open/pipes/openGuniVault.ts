...
import { validateIlk } from 'features/shared/configureVaultInputs'
...
import { configureGuniVaultInputs } from '../../../../shared/configureVaultInputs'
...
export function createOpenGuniVault$({
  ...
  const vaultInputs$ = configureGuniVaultInputs({
    connectedContext$,
    txHelpers$,
    priceInfo$,
    balanceInfo$,
  ...
  return vaultInputs$.pipe(
    ...
    switchMap(
      ({
        ...
        const { ilkDebtAvailable } = ilkData
