import { getCollaterals, getCollateralTokens } from 'apps/main/blockchain/addresses/addressesUtils'
import mainnet from 'apps/main/blockchain/addresses/mainnet.json'
import { supportedIlks } from 'apps/main/blockchain/config'
