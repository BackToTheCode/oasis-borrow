import { NetworkIds } from 'apps/main/blockchain/network'
import { isAppContextAvailable, useAppContext } from 'apps/main/components/AppContextProvider'
import {
  firstNotificationsRelevantDate,
  maxNumberOfNotifications,
} from 'apps/main/features/notifications/consts'
import { prepareNotificationMessageHandlers } from 'apps/main/features/notifications/handlers'
import {
  NOTIFICATION_CHANGE,
