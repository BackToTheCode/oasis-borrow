...
import { StopLossBannerControl } from 'apps/main/features/automation/protection/stopLoss/controls/StopLossBannerControl'
import { formatAmount, formatPercent } from 'apps/main/helpers/formatters/format'
import { ModalProps, useModal } from 'apps/main/helpers/modalHook'
