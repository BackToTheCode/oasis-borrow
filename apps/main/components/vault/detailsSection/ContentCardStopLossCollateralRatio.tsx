...
import { ContentCardProps, DetailsSectionContentCard } from 'apps/main/components/DetailsSectionContentCard'
import { formatPercent } from 'apps/main/helpers/formatters/format'
