...
import { useSharedUI } from 'apps/main/components/SharedUIProvider'
import { ModalProps } from 'apps/main/helpers/modalHook'
...
import { TRANSITIONS } from 'apps/main/theme'
import {
  Box,
  Button,
  Card,
