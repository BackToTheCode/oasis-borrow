...
import { TokenMetadataType } from 'apps/main/blockchain/tokensMetadata'
import { useAppContext } from 'apps/main/components/AppContextProvider'
import { calculateSimulation } from 'apps/main/features/earn/aave/open/services'
import { useEarnContext } from 'apps/main/features/earn/EarnContextProvider'
import { AppSpinner, WithLoadingIndicator } from 'apps/main/helpers/AppSpinner'
import { WithErrorHandler } from 'apps/main/helpers/errorHandlers/WithErrorHandler'
import { formatHugeNumbersToShortHuman, formatPercent } from 'apps/main/helpers/formatters/format'
