import { isAppContextAvailable } from 'apps/main/components/AppContextProvider'
import { Footer } from 'apps/main/components/Footer'
import { AppHeader, ConnectPageHeader } from 'apps/main/components/Header'
import { AppLinkProps } from 'apps/main/components/Links'
import { WithChildren } from 'apps/main/helpers/types'
import React from 'react'
import { Container, Flex, SxStyleProp } from 'theme-ui'
import { Background } from 'apps/main/theme/Background'
import { BackgroundLight } from 'apps/main/theme/BackgroundLight'
import { BackgroundLighter } from 'apps/main/theme/BackgroundLighter'
