import { ilksNotSupportedOnGoerli } from 'apps/main/blockchain/config'
import { ContextConnected } from 'apps/main/blockchain/network'
import { UIChanges } from 'apps/main/components/AppContext'
import { getProductCategoryUrl, ProductCategory } from 'apps/main/config/product-categories'
import {
  SWAP_WIDGET_CHANGE_SUBJECT,
  SwapWidgetChangeAction,
} from 'apps/main/features/uniswapWidget/SwapWidgetChange'
import { mapTokenToFilter, supportedEarnIlks } from 'apps/main/helpers/productCards'
