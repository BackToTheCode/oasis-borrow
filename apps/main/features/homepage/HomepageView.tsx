...
import { InfoCard } from 'apps/main/components/InfoCard'
...
} from 'apps/main/components/productCards/ProductCardsContainer'
import { ReferralBanner } from 'apps/main/components/ReferralBanner'
import { TabBar } from 'apps/main/components/TabBar'
import { LANDING_PILLS } from 'apps/main/content/landing'
import { NewReferralModal } from 'apps/main/features/referralOverview/NewReferralModal'
import { TermsOfService } from 'apps/main/features/termsOfService/TermsOfService'
import { formatAsShorthandNumbers } from 'apps/main/helpers/formatters/format'
import { useObservable } from 'apps/main/helpers/observableHook'
import { productCardsConfig } from 'apps/main/helpers/productCards'
import { useFeatureToggle } from 'apps/main/helpers/useFeatureToggle'
import { useLocalStorage } from 'apps/main/helpers/useLocalStorage'
import { Trans, useTranslation } from 'next-i18next'
import { useRouter } from 'next/router'
import React, { useEffect, useState } from 'react'
import { Box, Flex, Grid, Heading, SxProps, SxStyleProp, Text } from 'theme-ui'
import { fadeInAnimation, slideInAnimation } from 'apps/main/theme/animations'
