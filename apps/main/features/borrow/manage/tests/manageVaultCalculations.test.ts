...
import { HOUR } from 'apps/main/components/constants'
import {
  calcDebtScalingFactor,
  debtScalingFactor$,
  DEFAULT_DEBT_SCALING_FACTOR,
} from 'apps/main/helpers/mocks/ilks.mock'
import { mockManageInstiVault$, mockManageVault } from 'apps/main/helpers/mocks/manageVault.mock'
