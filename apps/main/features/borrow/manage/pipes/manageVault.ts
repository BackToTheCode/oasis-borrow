...
import { MakerVaultType } from 'apps/main/blockchain/calls/vaultResolver'
import { createIlkDataChange$, IlkData } from 'apps/main/blockchain/ilks'
import { Context } from 'apps/main/blockchain/network'
import { createVaultChange$, Vault } from 'apps/main/blockchain/vaults'
import { AddGasEstimationFunction, TxHelpers } from 'apps/main/components/AppContext'
import { SelectedDaiAllowanceRadio } from 'apps/main/components/vault/commonMultiply/ManageVaultDaiAllowance'
import {
  createAutomationTriggersChange$,
  TriggersData,
} from 'apps/main/features/automation/api/automationTriggersData'
...
import {
  ...
  VaultType,
} from 'apps/main/features/generalManageVault/vaultType'
