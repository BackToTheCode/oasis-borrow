...
import { DEFAULT_DEVIATION, DEFAULT_MAX_BASE_FEE_IN_GWEI } from 'apps/main/features/automation/common/consts'
import {
...
import { DEFAULT_TARGET_OFFSET } from 'apps/main/features/automation/optimization/constantMultiple/state/useConstantMultipleStateInitialization'
