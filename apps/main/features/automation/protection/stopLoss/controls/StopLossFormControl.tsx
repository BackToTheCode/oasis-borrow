...
import { MAX_DEBT_FOR_SETTING_STOP_LOSS } from 'apps/main/features/automation/common/consts'
...
import { SidebarSetupStopLoss } from 'apps/main/features/automation/protection/stopLoss/sidebars/SidebarSetupStopLoss'
import {
  STOP_LOSS_FORM_CHANGE,
  StopLossFormChange,
} from 'apps/main/features/automation/protection/stopLoss/state/StopLossFormChange'
import { getStopLossStatus } from 'apps/main/features/automation/protection/stopLoss/state/stopLossStatus'
import { StopLossTriggerData } from 'apps/main/features/automation/protection/stopLoss/state/stopLossTriggerData'
import { getStopLossTxHandlers } from 'apps/main/features/automation/protection/stopLoss/state/stopLossTxHandlers'
