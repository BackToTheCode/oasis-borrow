...
import { AfterPillProps } from 'apps/main/components/vault/VaultDetails'
import { StopLossBannerLayout } from 'apps/main/features/automation/protection/stopLoss/controls/StopLossBannerLayout'
