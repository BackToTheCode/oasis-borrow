...
import { networksById } from 'apps/main/blockchain/config'
import { Context, every5Seconds$ } from 'apps/main/blockchain/network'
import { Vault } from 'apps/main/blockchain/vaults'
import { getAllActiveTriggers } from 'apps/main/features/automation/api/allActiveTriggers'
import {
  AutoBSTriggerData,
  extractAutoBSData,
} from 'apps/main/features/automation/common/state/autoBSTriggerData'
import { extractAutoTakeProfitData } from 'apps/main/features/automation/optimization/autoTakeProfit/state/autoTakeProfitTriggerData'
import {
