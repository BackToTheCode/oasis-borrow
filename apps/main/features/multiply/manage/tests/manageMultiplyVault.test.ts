...
import { protoTxHelpers } from 'apps/main/components/AppContext'
import { mockManageMultiplyVault$ } from 'apps/main/helpers/mocks/manageMultiplyVault.mock'
import { mockTxState } from 'apps/main/helpers/mocks/txHelpers.mock'
import { DEFAULT_PROXY_ADDRESS, defaultCollateral, defaultDebt } from 'apps/main/helpers/mocks/vaults.mock'
