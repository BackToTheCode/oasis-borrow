import { WithVaultFormStepIndicator } from 'apps/main/components/vault/VaultForm'
import { ManageMultiplyVaultEditingStage } from 'apps/main/features/multiply/manage/pipes/manageMultiplyVault'
