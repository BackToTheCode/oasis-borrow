...
import { createIlkDataChange$, IlkData } from 'apps/main/blockchain/ilks'
import { ContextConnected } from 'apps/main/blockchain/network'
import { isSupportedAutomationIlk } from 'apps/main/blockchain/tokensMetadata'
import { AddGasEstimationFunction, TxHelpers } from 'apps/main/components/AppContext'
import {
...
} from 'apps/main/features/automation/protection/stopLoss/openFlow/openVaultStopLoss'
import {
  addStopLossTrigger,
  applyStopLossOpenFlowTransaction,
} from 'apps/main/features/automation/protection/stopLoss/openFlow/stopLossOpenFlowTransaction'
import { OpenVaultStopLossSetup } from 'apps/main/features/borrow/open/pipes/openVault'
import { calculateInitialTotalSteps } from 'apps/main/features/borrow/open/pipes/openVaultConditions'
import { ExchangeAction, ExchangeType, Quote } from 'apps/main/features/exchange/exchange'
import { createProxy } from 'apps/main/features/proxy/createProxy'
import { BalanceInfo, balanceInfoChange$ } from 'apps/main/features/shared/balanceInfo'
import { PriceInfo, priceInfoChange$ } from 'apps/main/features/shared/priceInfo'
import { slippageChange$, UserSettingsState } from 'apps/main/features/userSettings/userSettings'
import { GasEstimationStatus, HasGasEstimation } from 'apps/main/helpers/form'
import { combineApplyChanges } from 'apps/main/helpers/pipelines/combineApply'
