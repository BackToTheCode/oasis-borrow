...
import { extractAutoBSData } from 'apps/main/features/automation/common/state/autoBSTriggerData'
import { extractStopLossData } from 'apps/main/features/automation/protection/stopLoss/state/stopLossTriggerData'
