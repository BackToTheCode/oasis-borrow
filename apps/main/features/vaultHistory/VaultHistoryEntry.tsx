...
import { DefinitionList, DefinitionListItem } from 'apps/main/components/DefinitionList'
import { AppLink } from 'apps/main/components/Links'
import { VaultChangesInformationArrow } from 'apps/main/components/vault/VaultChangesInformation'
import { WithArrow } from 'apps/main/components/WithArrow'
import { maxUint32, maxUint256 } from 'apps/main/features/automation/common/consts'
...
import { AutomationEvent } from 'apps/main/features/vaultHistory/vaultHistoryEvents'
import {
  formatAddress,
  formatCryptoBalance,
  formatFiatBalance,
  formatPercent,
} from 'apps/main/helpers/formatters/format'
import { interpolate } from 'apps/main/helpers/interpolate'
