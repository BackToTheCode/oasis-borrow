...
import { compareBigNumber, ContextConnected } from 'apps/main/blockchain/network'
...
} from 'apps/main/features/allowance/allowance'
...
import { TxStage } from 'apps/main/features/multiply/open/pipes/openMultiplyVault' // TODO: remove
import { finalValidation } from 'apps/main/features/multiply/open/pipes/openMultiplyVaultValidations'
import {
  addProxyTransitions,
  applyIsProxyStage,
  applyProxyChanges,
  ...
  ProxyStages,
  ProxyState,
} from 'apps/main/features/proxy/proxy'
...
import { GUNI_SLIPPAGE, OAZO_LOWER_FEE } from 'apps/main/helpers/multiply/calculations'
import { combineApplyChanges } from 'apps/main/helpers/pipelines/combineApply'
import { combineTransitions } from 'apps/main/helpers/pipelines/combineTransitions'
