...
import { GasPriceParams } from 'apps/main/blockchain/prices'
import { DetailsSection } from 'apps/main/components/DetailsSection'
import { DetailsSectionContentTable } from 'apps/main/components/DetailsSectionContentTable'
import { DetailsSectionFooterItemWrapper } from 'apps/main/components/DetailsSectionFooterItem'
import { ContentFooterItemsEarnSimulate } from 'apps/main/components/vault/detailsSection/ContentFooterItemsEarnSimulate'
import {
  calculateBreakeven,
  calculateEarnings,
  Yield,
  YieldPeriod,
} from 'apps/main/helpers/earn/calculations'
import { OAZO_LOWER_FEE } from 'apps/main/helpers/multiply/calculations'
