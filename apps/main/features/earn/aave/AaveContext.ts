import { getAaveAssetsPrices } from 'apps/main/blockchain/calls/aave/aavePriceOracle'
import { getAaveReserveData } from 'apps/main/blockchain/calls/aave/aaveProtocolDataProvider'
import { observe } from 'apps/main/blockchain/calls/observe'
import { getGasEstimation$, getOpenProxyStateMachine$ } from 'apps/main/features/proxyNew/pipelines'
