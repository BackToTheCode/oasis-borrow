...
import { readOnlyEnhanceProvider } from 'apps/main/blockchain/readOnlyEnhancedProviderProxy'
import { SetupWeb3Context } from 'apps/main/blockchain/web3Context'
import { AppContextProvider } from 'apps/main/components/AppContextProvider'
import { CookieBanner } from 'apps/main/components/CookieBanner'
import { GasEstimationContextProvider } from 'apps/main/components/GasEstimationContextProvider'
import { HeadTags, PageSEOTags } from 'apps/main/components/HeadTags'
import { AppLayout, MarketingLayoutProps } from 'apps/main/components/Layouts'
import { CustomMDXLink } from 'apps/main/components/Links'
import { NotificationSocketProvider } from 'apps/main/components/NotificationSocketProvider'
import { SharedUIProvider } from 'apps/main/components/SharedUIProvider'
import { cache } from 'emotion'
import { ModalProvider } from 'apps/main/helpers/modalHook'
...
import { theme } from 'apps/main/theme'
// @ts-ignore
