...
import addingStopLossAnimation from 'apps/main/theme/lottie/addingStopLossAnimation.json'
import openVaultAnimation from 'apps/main/theme/lottie/openVaultAnimation.json'
